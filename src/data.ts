...
export const workDetails: Record<string, WorkDetail> = {
  ...
  'kudus-disaster-mapping': {
    ...
    highlights: [
      ...
      { label: 'Timeframe', value: 'Dec 2024 — Feb 2025' },
  ...
  'digital-systems': {
    ...
    highlights: [
      ...
      { label: 'Timeframe', value: 'Aug — Dec 2024' },
...
export const mapCards: MapCard[] = [
  {
    ...
    path: '/about',
    type: 'B',
    image: '/tirta-profile.jpg',
  },
  {
    id: 'experience',
    num: '03',
    title: 'Experience',
    description: '8 roles across professional, organizational, and Web3.',
    path: '/experience',
    type: 'C',
  },
  {
    ...
    num: '04',
    title: 'Selected Work',
    description: 'Case studies: BPBD GIS hazard mapping & academic assistance.',
    path: '/work',
    type: 'B',
  ...
  },
  {
    ...
    num: '06',
    title: 'Content',
    description: 'Web3 research, Ethereum upgrades, and ecosystem analytics.',
    path: '/content',
    type: 'B',
  ...
  },
  {
    ...
    num: '08',
    title: 'Credentials',
    description: 'Academic record, certificates, and physics degree honors.',
    path: '/credentials',
    type: 'A',
  },
  {
